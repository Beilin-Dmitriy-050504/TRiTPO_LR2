...
У авторизованных пользователей имеется возможность редактирования профиля, включая имя, почту, аватар. При наличии подписки появляются дополнительные возможности, такие как: просмотр статистики, поиск музыки по звуку и т.д.
