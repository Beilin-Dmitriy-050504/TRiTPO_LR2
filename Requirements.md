...
| Регистрация со сторонних аккаунтов | Приложение должно предоставить доступ ко входу в аккаунт через ранее созданные аккаунты Google/Вконтакте/Facebook и т.д.|

#### 3.1.1.2 Настройка профиля активного пользователя
**Описание.** Пользователь имеет возможность редактирования профиля.
